...
const grupch2 = 'https://chat.whatsapp.com/CXLFv9R7S2O6YsOguCEqK4'; // OFFICIAL GRUP LU 2
//
...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] Wa bot vira  Ready Scan cok!`);
});
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by vira✿`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by vira✿`)
})
...
conn.sendMessage(id, 'Ya?, Ketik .menu/.info/.donasi Contoh' ,MessageType.text);
}
else if (text == 'P'){
conn.sendMessage(id, 'Ya?, Ketik .menu/.info/.donasi Contoh' ,MessageType.text);
}
...
conn.sendMessage(id, 'Owner wa.me/+6287877173955' ,MessageType.text);
}
else if (text == '.creator'){
conn.sendMessage(id, 'Creator wa.me/+6287877173955' ,MessageType.text);
}
else if (text == '.github bot'){
conn.sendMessage(id, 'chat pribadi aja wa.me/+6287877173955' ,MessageTyp      >
}
else if (text == 'VIRA'){
conn.sendMessage(id, 'ya Aku BOT nya FERDI' ,MessageType.text);
}
...
conn.sendMessage(id, 'Aku Bot...ketik .menu'  ,MessageType.text);
}
else if (text == 'Hai'){
conn.sendMessage(id, 'Ya?, Ketik .info/.donasi/.menu Contoh .help' ,MessageType.text);
}
else if (text == 'Woi'){
conn.sendMessage(id, 'Ya?, Ketik .menu/#info/#donasi Contoh #help' ,MessageType.text);
}
else if (text == 'Eoy'){
conn.sendMessage(id, 'Ya?, Ketik .menu/#info/#donasi Contoh #help' ,MessageType.text);
}
...
axios.get(`https://alfians-api.herokuapp.com/api/wiki?q=${teks}`).then((res) => {
	conn.sendMessage(id, '[WAIT] Searching ⏳ silahkan tunggu sebentar❗', MessageType.text)
...
const get = require('got')
    ...
    conn.sendMessage(id,`🗂️DATA COVID-19 *UPDATE* DIINDONESIA\n\n📈Positif ==> ${positif} \n📉Sembuh ==> ${sembuh} \n📋Meninggal ==> ${meninggal}\n🗒️Dirawat ==> ${dirawat}`, MessageType.text);
}
